...
@Component({
  selector: 'app-grievance-inbox',
  templateUrl: './grievance-inbox.component.html',
  styleUrls: ['./grievance-inbox.component.scss']
})
export class GrievanceInboxComponent implements OnInit {
  //bread crumb items
