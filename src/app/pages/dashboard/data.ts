...
const topTenBuyerChart: ChartType = {
  chart: {
    width: 227,
    height: 227,
    type: 'pie'
...
const tradeStatusChart: ChartType = {
  chart: {
    width: 227,
    height: 227,
    type: 'pie'
...
export { walletOverview,qualityChart,topTenBuyerChart,tradeStatusChart, investedOverview, marketOverview, recentActivity, walletlineChart, tradeslineChart, investedlineChart, profitlineChart, News, transactionsAll, transactionsBuy, transactionsSell };
